...
- neuer Branch mit Erwähnung der issue-nummer, über das Issue gehen und "create new branch" wählen, aus main heraus
- Änderungen in der Datei vornehmen
- ggf. Datei hochladen, Änderung committen mit Erwähnung der issue-nummer
